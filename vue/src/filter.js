//公司行业
export function industryFilter (industry) {
    switch (industry) {
        case 0:
            return '移动互联网';
        case 1:
...
//公司融资阶段
export function financingFilter (financing) {
    switch (financing) {
        case 0:
            return '无需融资';
        case 1:
...
//工作经验
export function experienceFilter (experience) {
    switch (experience) {
        case 0:
            return '应届';
        case 1:
...
//工作经验
export function educationFilter (education) {
    switch (education) {
        case 0:
            return '大专';
        case 1:
...
//薪资水平
export function compensationFilter (compensation) {
    switch (compensation) {
        case 0:
            return '8K';
        case 1:
...
//省市区过滤
export function provinceFilter (id) {
    if (id != undefined && id != '') {
        var name;
        PROVINCE.forEach(function (data) {
            if (data.ProID == id) {
                name = data.ProName;
            }
        });
...
export function countyFilter (id) {
    if (id != undefined && id != '') {
        var name;
